...
export const createStandardizedUserObject = (userData: any) => {
  ...
  return {
    ...
    first_name: userData.first_name || userData.firstName || 'ユーザー',
    last_name: userData.last_name || userData.lastName || '',
    avatar_url: userData.avatar_url || userData.avatarUrl,
    about_me: userData.about_me || userData.bio,
    age: userData.age,
    ...
    learning_languages: userData.learning_languages || userData.learningLanguages || [],
