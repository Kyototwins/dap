  ...
  return <div className="space-y-4">
      <div className="flex flex-col md:flex-row gap-3">
        ...
        <div className="flex space-x-3 w-full">
          <input type="date" value={dateFilter} onChange={handleDateFilterChange} className="px-3 py-2 border border-gray-200 rounded-lg text-sm flex-1" aria-label="Filter by date" />
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <Checkbox id="header-hide-past-events" checked={hidePastEvents} onCheckedChange={checked => onHidePastEventsChange(checked as boolean)} />
