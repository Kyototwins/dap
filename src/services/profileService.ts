...
export async function updateUserProfile(
  ...
  foodPhotoUrl: string | null  // Changed from petPhotoUrl
) {
  ...
  const { error } = await supabase
    ...
    .update({
      ...
      favorite_food_photo_url: foodPhotoUrl,  // Changed from pet_photo_url
      photo_comment: formData.photoComment,
      hobby_photo_comment: formData.hobbyPhotoComment,
      favorite_food_photo_comment: formData.foodPhotoComment,  // Changed from pet_photo_comment
